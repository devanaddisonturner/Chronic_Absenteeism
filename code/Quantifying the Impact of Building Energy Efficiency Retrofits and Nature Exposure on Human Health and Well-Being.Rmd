...
CASchools_PSM_Datacomplete <- complete(CASchools_PSM_Dataimp)
...
scaling_maxmin_complete <- as.data.frame(lapply(CASchools_PSM_Datacomplete, maxmin_scalar_complete))
