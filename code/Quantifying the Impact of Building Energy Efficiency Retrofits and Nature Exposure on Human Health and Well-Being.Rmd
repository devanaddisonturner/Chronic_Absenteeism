...
#Read individual data files to obtain total counts of treatments for the following variables (i) retrofit, (ii) ndvi_binary, (iii) retrofit and ndvi
#Group by the unique CDS_Code 
