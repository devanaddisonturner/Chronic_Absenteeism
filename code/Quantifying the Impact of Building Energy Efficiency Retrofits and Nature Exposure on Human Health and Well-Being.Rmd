...
```{r}
# Number of Treatments for K-12 Schools in each policy intervention/scenario

#Method 1: Read individual data files to obtain total counts of treatments across each scenario and intervention including subset of EE retrofit
#for the following variables (i) retrofit, (ii) ndvi_binary, (iii) retrofit and ndvi

#Method 2: Read only the first file with the complete dataset and obtain total count of treatments across each scenario and intervention 
#Group by the unique CDSCode 
...
length(unique(Treatment_Count_Data_All$CDSCode_2))

library(dplyr)
#Calculate the sum of interventions in each scenario by K-12 school
...
```{r}
#Analyze Subset Data by Lighting Retrofits in K-12 schools 
Treatment_Count_Data_SubL <- read_csv("./data/Treatment_Count_Data_SubL.csv")

#Analyze Subset Data by HVAC Retrofits in K-12 schools 
Treatment_Count_Data_SubH <- read_csv("./data/Treatment_Count_Data_SubH.csv")

#Analyze Subset Data by Building Envelope Retrofits in K-12 schools 
Treatment_Count_Data_SubB <- read_csv("./data/Treatment_Count_Data_SubB.csv")

#Analyze Subset Data by Pumps, Motors, and Drives in K-12 schools 
Treatment_Count_Data_SubP <- read_csv("./data/Treatment_Count_Data_SubP.csv")
```
