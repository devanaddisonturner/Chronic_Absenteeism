...
```{r}
#Graph the Relationship of LULC, NDVI, and LST [YJL: there is no need to have this figure]
library(ggplot2)
ggplot() + 
...
# Heatmap of Occupant Health by Intervention and Utility Service Area [YJL: not clear what this is, may not need for your publication]
```{r}
library(dplyr)
library(readr)
Scenario_HeatMap_Data <- read_csv("./data/Scenario_HeatMap_Data.csv")
