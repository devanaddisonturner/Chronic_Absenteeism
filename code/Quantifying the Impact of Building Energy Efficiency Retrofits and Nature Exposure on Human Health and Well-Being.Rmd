...
labs(title = "Statistical Power Analysis of Scenario 1: The Impact of Energy Efficiency Retrofits on Chronic Absenteeism in K-12 Schools", x = "Sample Size", y = "P-value", color = "Effect Size") + theme(plot.title = element_text(hjust = 0.5))  # Center ggplot title

ggsave(filename = './figures/', 'PowerAnalysis_EERetrofits.png', plot = last_plot(), width = 12, height = 7, units = "in", dpi = 300)
...
labs(title = "Statistical Power Analysis of Scenario 2: The Impact of Nature Exposure on Chronic Absenteeism in K-12 Schools", x = "Sample Size", y = "P-value", color = "Effect Size") + theme(plot.title = element_text(hjust = 0.5))  # Center ggplot title

ggsave(filename = './figures/', 'PowerAnalysis_NatureExposure.png', plot = last_plot(), width = 12, height = 7, units = "in", dpi = 300)
...
labs(title = "Statistical Power Analysis of Scenario 3: The Impact of Lighting Retrofits and Nature Exposure on Chronic Absenteeism in K-12 Schools", x = "Sample Size", y = "P-value", color = "Effect Size") + theme(plot.title = element_text(hjust = 0.5))  # Center ggplot title

ggsave(filename = './figures/', 'PowerAnalysis_LightingRetrofitsandNatureExposure.png', plot = last_plot(), width = 12, height = 7, units = "in", dpi = 300)
...
labs(title = "Statistical Power Analysis of Scenario 3: The Impact of HVAC Retrofits and Nature Exposure on Chronic Absenteeism in K-12 Schools", x = "Sample Size", y = "P-value", color = "Effect Size") + theme(plot.title = element_text(hjust = 0.5))  # Center ggplot title

ggsave(filename = './figures/', 'PowerAnalysis_HVACRetrofitsandNatureExposure.png', plot = last_plot(), width = 12, height = 7, units = "in", dpi = 300)
```
