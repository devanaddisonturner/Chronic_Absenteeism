...
ggsave(filename = 'PowerAnalysis_EERetrofits.png', plot = last_plot(), width = 12, height = 7, units = "in", dpi = 300)
...
ggsave(filename = 'PowerAnalysis_NatureExposure.png', plot = last_plot(), width = 12, height = 7, units = "in", dpi = 300)
...
ggsave(filename = 'PowerAnalysis_LightingRetrofitsandNatureExposure.png', plot = last_plot(), width = 12, height = 7, units = "in", dpi = 300)
...
ggsave(filename = 'PowerAnalysis_HVACRetrofitsandNatureExposure.png', plot = last_plot(), width = 12, height = 7, units = "in", dpi = 300)
```
