...
ES <- 1.85 
##' could you use script/variable to get `ES`, instead of manually assign a value? 
##'   I cannot find which data can be used to het 1.85

#' get mean2 depending on value of ES from 
#'  d = (u1 - u2)/sd
#'  es = (mean1 - mean2)/sd
mean2 = 0.30 
##' could you use script/variable to get `mean2`, instead of manually assign a value? 
##'   e.g., Mean2 for Control Group = Chronic_Absenteeism.x
