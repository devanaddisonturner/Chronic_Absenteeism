...
## Packages --------------------------------------------------------------------
# install.packages("readr", dependecies = TRUE)
...
#the MICE algorithm
set.seed(123)
CASchools_PM_Dataimp <- mice(CASchools_PM_Data2, seed = 123)
