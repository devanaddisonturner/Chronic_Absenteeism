...
cex.axis.size = 0.425
VIM::aggr(CASchools_PM_Data2, cex.axis=cex.axis.size, cex.lab = cex.axis.size*1.5)
dev.off()
...
png(filename = f, width = 7, height = 5, units = "in", res = 300)
aggr(CASchools_PM_Datacomplete, cex.axis=cex.axis.size, cex.lab = cex.axis.size*1.5)
dev.off()
