...
png(filename = f, width = 9, height = 5, units = "in", res = 300)
cex.axis.size = 0.425
...
ggsave(filename = './figures/effect_size_by_scenarios.png', plot = last_plot(), width = 7, height = 5, units = "in", dpi = 300)
```
...
ggsave(filename = './figures/effect_size.png', plot = last_plot(), width = 7, height = 5, units = "in", dpi = 300)
```
