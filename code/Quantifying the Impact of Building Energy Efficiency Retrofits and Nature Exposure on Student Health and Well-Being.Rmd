...
library(readxl)
library(ggplot2)
ChronicAbsenteeism_FinancialCost<- read_csv("ChronicAbsenteeism_FinancialCost.csv")
# Create the bar chart
p <- ggplot(ChronicAbsenteeism_FinancialCost, aes(x = Intervention, y = Potential_Financial_Cost_Savings, color = Intervention, fill = Intervention)) +
  geom_bar(stat = "identity", position = "identity") +
  geom_text(aes(label = Potential_Financial_Cost_Savings), vjust = -0.3) + 
  labs(title = "Potential Financal Cost Savings of Interventions in K-12 Schools",
       x = "Intervention",
       y = "Potential Cost ($)") +
  theme_bw()
...
print(p)
ggsave(filename = 'ChronicAbsenteeism_InterventionCost.png', plot = last_plot(), width =6.5, height = 4, units = "in", dpi = 300)
```
