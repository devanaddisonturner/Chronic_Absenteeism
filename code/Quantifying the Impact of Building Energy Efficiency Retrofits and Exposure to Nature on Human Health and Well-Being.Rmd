...
CASchools_PM_Data_income_sub <- read_csv("./data/CA_Schools_PSM_Data_income_sub.csv")

ggplot(CASchools_PM_Data_income_sub, aes(x = Pollution_Burden, y = Chronic_Absenteeism, color =  Diversity_Index, alpha = 0.5)) + 
...
labs(x = "Pollution Burden, %", 
       ...
       title = "Pollution Burden and Chronic Absenteeism in K-12 Schools by Income and Racial Diversity in California") + 
  theme(plot.title = element_text(hjust = 0.5))  # Center ggplot title

ggsave(filename = 'Chronic_Absenteeism_by_SEProfile.png', plot = last_plot(), width = 7, height = 5, units = "in", dpi = 300)
```
...
CASchools_PM_Data_income_sub <- read_csv("./data/CASchools_PM_Data_income_subset.csv")

#Install then load package to plot C-matrix 
install.packages("corrplot")
library(corrplot)
my_data <- CASchools_PM_Data_income_sub[, c(2:20)]
f2 <- paste0('Pearson_Correlation_Matrix2.png'); print(f)
...
print(p)
ggsave(filename = 'Correlation_Plot.png', plot = last_plot(), width = 7, height = 4, units = "in", dpi = 300, bg="white")
...
print(p2)
ggsave(filename = 'Correlation_Plot_2.png', plot = last_plot(), width = 7, height = 4, units = "in", dpi = 300, bg="white")
