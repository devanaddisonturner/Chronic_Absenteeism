...
CASchools_PSM_Data_income_subset$income_f = factor(CASchools_PSM_Data_income_subset$income, levels=c('high income','medium income','low income'))

ggplot(CASchools_PSM_Data_income_subset, aes(x = Pollution_Burden, y = Chronic_Absenteeism, color =  Diversity_Index, alpha = 0.5)) + 
...
ggsave(filename = paste0('./figures/'Pollution_ChronicAbsenteeism_SEProfile.png', plot = last_plot(), width = 9, height = 6, units = "in", dpi = 300)
```
